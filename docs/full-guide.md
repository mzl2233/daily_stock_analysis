...
| Secret 名称 | 说明 | 必填 |
|------------|------|:----:|
| `STOCK_LIST` | 自选股代码，支持 `代码:备注`，如 `600519:贵州茅台,300750:宁德时代,002594` | ✅ |
...
| 变量名 | 说明 | 默认值 |
|--------|------|--------|
| `STOCK_LIST` | 自选股代码（逗号分隔），支持 `代码:备注`，如 `600519:贵州茅台,hk00700:腾讯控股` | - |
...
### Q: 如何添加自选股？
A: 修改 `STOCK_LIST` 环境变量，多个代码用逗号分隔；如需跳过慢速名称拉取，可使用 `代码:备注`，例如 `600519:贵州茅台,hk00700:腾讯控股`。
